...
const PLAYLISTS = [
  ...
  { value: 'fresh-releases',     name: 'Fresh Releases',     scheduleKey: 'FRESH_RELEASES_SCHEDULE',     flagsKey: 'FRESH_RELEASES_FLAGS',     defaultDay: 3,  defaultHour: 8,  defaultMinute: 30 },
]
